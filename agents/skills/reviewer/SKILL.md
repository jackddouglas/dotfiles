...
- If the current conversation has no prior work on the diff being reviewed, it
...
- If this conversation participated in authoring, implementing, or previously
  analyzing the diff, use the `subagent` tool when available. It owns safe
